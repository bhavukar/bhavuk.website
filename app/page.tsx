  ...
  return (
    <>
      {mode === 'machine' ? (
        ...
        <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-[#f7efe2] selection:text-zinc-950 relative">
      {/* ─────────────────────────────────────────────────────────────
        ...
        >
          <div className="space-y-4 sm:space-y-6 max-w-3xl">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-zinc-950 leading-[1.25] sm:leading-[1.22] max-w-2xl">
              Building{' '}
              <span className="bg-[#f7efe2] text-zinc-950 px-1.5 sm:px-2 py-0.5 rounded-sm">
                consumer
              </span>{' '}
              <span className="bg-[#f7efe2] text-zinc-950 px-1.5 sm:px-2 py-0.5 rounded-sm">
                products
                      ...
                      <div className="relative inline-flex items-center">
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between px-2 pt-2 pb-0.5 text-[11px] font-mono">
                            ...
                            <span className="text-[#f7efe2] font-semibold text-[10px] flex items-center gap-0.5">
                              <span>Open</span>
            ...
            <div className="p-3.5 sm:p-4 rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                >
                  {copiedEmail ? (
                    <>
                      <Check size={13} className="text-[#f7efe2]" />
                      <span className="text-[#f7efe2]">Copied</span>
                    </>
                  ) : (
                    <>
                      <Copy size={13} />
                ...
                <a
                  ...
                  className="px-3.5 sm:px-4 py-2 rounded-lg bg-[#f7efe2] hover:bg-[#ede4d4] text-zinc-950 text-xs font-mono font-bold transition-all flex items-center justify-center gap-1 hover:translate-y-[-1px]"
                >
                  <span>Mailto</span>
